...
static const char __rcs_id_mos_mapfuncs_h[] = "$Id: mapfuncs.h,v 1.2 1999-02-19 09:26:29 stephensk Exp $";
#endif
#endif /* __rcs_id__ */
...
static __inline__
mos_map_slot * _mos_map_findEqualByValue(mos_map *map, mos_value key)
{
  mos_map_LOOP(map,ms)
