#ifndef __rcs_id__
#ifndef __rcs_id_mos_integer_c__
#define __rcs_id_mos_integer_c__
static const char __rcs_id_mos_integer_c[] = "$Id: integer.c,v 1.3 1999-12-26 20:05:52 stephensk Exp $";
#endif
#endif /* __rcs_id__ */
