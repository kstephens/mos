#ifndef __rcs_id__
#ifndef __rcs_id_mos_traceMethod_c__
#define __rcs_id_mos_traceMethod_c__
static const char __rcs_id_mos_traceMethod_c[] = "$Id: traceMethod.c,v 1.3 1999-12-26 20:06:06 stephensk Exp $";
#endif
#endif /* __rcs_id__ */
